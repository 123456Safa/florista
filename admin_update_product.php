...
if(!isset($admin_id)){ //vérifie si l'ID de l'administrateur est défini dans la session. Si ce n'est pas le cas,
                      //cela signifie que l'utilisateur n'est pas connecté et il est redirigé vers la page de connexion (login.php)
...
<head>
   ...
   <!-- 
Ce lien correspond à une feuille de style hébergée sur le service CDN (Content Delivery Network) de Cloudflare. Plus précisément, 
   il charge la version 6.0.0 de Font Awesome, 
   une bibliothèque d'icônes populaires, au format CSS (Cascading Style Sheets). -->
...
<form action="" method="post" enctype="multipart/form-data"><!-- utilisé pour permettre l'envoi de fichiers binaires,-->
