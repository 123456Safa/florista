...
<section class="shopping-cart">
    ...
    <div class="cart-total">
        ...
        <a href="checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">proceed to checkout</a> <!-- ? It is a shorthand way of writing an if statement-->
    <!-- '': This is the value to be echoed if the condition ( $grand_total > 1) is true-->
    </div>
